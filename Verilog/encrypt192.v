...
//----------------------------------------------------------------------------------------------------------------------
   ...
   localparam                          KEY_WIDTH           = DATA_WIDTH*16*13;
...
//---------------------------------------------------------------------------------------------------------------------
   ...
   wire       [INOUT_WIDTH-1:0]        w_bytes_out [0:13];
   wire       [13:0]                   w_bytes_valid_out;

   wire       [INOUT_WIDTH-1:0]        w_roundKey [0:12];
...
//---------------------------------------------------------------------------------------------------------------------
   ...
   assign {          w_roundKey[12], w_roundKey[11],w_roundKey[10],w_roundKey[9], w_roundKey[8],
