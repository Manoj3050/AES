...
//---------------------------------------------------------------------------------------------------------------------
   ...
   reg       [INOUT_WIDTH-1:0]        r_roundKey [0:14];
...
//---------------------------------------------------------------------------------------------------------------------
   ...
   initial begin
      $readmemh("roundkey256.hex",r_roundKey);
   end


  
   assign   w_roundKey = { r_roundKey[14] ,r_roundKey[13] ,r_roundKey[12] ,r_roundKey[11], r_roundKey[10], 
                           r_roundKey[9],  r_roundKey[8], r_roundKey[7], r_roundKey[6], r_roundKey[5],
