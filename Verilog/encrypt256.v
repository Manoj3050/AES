...
//----------------------------------------------------------------------------------------------------------------------
   ...
   localparam                          KEY_WIDTH           = DATA_WIDTH*16*15;
...
//---------------------------------------------------------------------------------------------------------------------
   ...
   wire       [INOUT_WIDTH-1:0]        w_bytes_out [0:15];
   wire       [15:0]                   w_bytes_valid_out;

   wire       [INOUT_WIDTH-1:0]        w_roundKey [0:14];
...
//---------------------------------------------------------------------------------------------------------------------
   ...
   assign {          w_roundKey[14],w_roundKey[13],w_roundKey[12], w_roundKey[11],w_roundKey[10],
                     w_roundKey[9], w_roundKey[8], w_roundKey[7], w_roundKey[6], w_roundKey[5], 
                     w_roundKey[4], w_roundKey[3], w_roundKey[2], w_roundKey[1], w_roundKey[0] } = round_key_i;
   ...
   (
      ...
      .round_key_i            ( w_roundKey[12] ),
      .bytes_o                ( w_bytes_out[12] ),
      .bytes_valid_o          ( w_bytes_valid_out[12] )
   ...
   (
      ...
      .rst_n_i                ( rst_n_i ),
      .enable_i               ( enable_i ),
      .process_start_i        ( w_bytes_valid_out[12] ),
      .busy_o                 (  ),
      .bytes_i                ( w_bytes_out[12] ),
      .round_key_i            ( w_roundKey[13] ),
      .bytes_o                ( w_bytes_out[13] ),
      .bytes_valid_o          ( w_bytes_valid_out[13] )
   ...
   (
      ...
      .rst_n_i                ( rst_n_i ),
      .enable_i               ( enable_i ),
      .process_start_i        ( w_bytes_valid_out[13] ),
      .busy_o                 (  ),
      .bytes_i                ( w_bytes_out[13] ),
      .bytes_o                ( w_bytes_out[14] ),
      .bytes_valid_o          ( w_bytes_valid_out[14] )
   ...
   (
      ...
      .rst_n_i                ( rst_n_i ),
      .enable_i               ( enable_i ),
      .process_start_i        ( w_bytes_valid_out[14] ),
      .busy_o                 (  ),
      .bytes_i                ( w_bytes_out[14] ),
      .bytes_o                ( w_bytes_out[15] ),
      .bytes_valid_o          ( w_bytes_valid_out[15] )
   );
   ...
   (
      ...
      .rst_n_i                ( rst_n_i ),
      .enable_i               ( enable_i ),
      .process_start_i        ( w_bytes_valid_out[15] ),
      .busy_o                 (  ),
      .bytes_i                ( w_bytes_out[15] ),
      .round_key_i            ( w_roundKey[14] ),
      .bytes_o                ( bytes_o ),
